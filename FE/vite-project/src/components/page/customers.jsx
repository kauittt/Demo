...
export function App() {
    ...
    return <div className="w-screen h-screen bg-main">
        ...
        <div className="flex">
            <div className="inline-flex flex-1 mx-20 items-center justify-center gap-10">
                ...
                <div className="bg-white flex-1 h-[42px] rounded-xl border-text border-2 items-center px-16 gap-10 flex">
                    ...
                    <input type="text" placeholder="Search customers..." className="placeholder-text flex-1" />
                </div>
                                    ...
                                    {action == index && (
                                        <div
                                            ...
                                            <ul>
                                                ...
                                                <li>
                                                    <button className="hover:bg-main w-[70px] p-2 rounded-xl">Delete</button>
                                                </li>
                                            </ul>
                                        </div>
                                    )}
