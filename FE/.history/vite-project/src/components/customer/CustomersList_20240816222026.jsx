        ...
        <div className=" bg-bgr p-[40px]">
            ...
            >
                ...
                <div className="flex justify-end cursor-pointer">
                    <div
                        className="w-[200px] h-[65px] rounded-3xl 
                ...
                {/*//* Table  */}
                <div className="flex ">
                    <table className="border-collapse border-spacing-4 divide-y spa divide-solid bg-white rounded-xl shadow-custom border-main flex-1 ">
                        <thead>
                            <tr>
