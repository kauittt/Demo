            ...
            >
                ...
                <div className="flex max-h-[389px] min-h-[389px]  rounded-xl mt-[20px]">
                    ...
                    >
                        <thead>
                            <tr>
                                <th className="p-3 w-[10%]">{t("table.id")}</th>
                                <th className="w-[30%]">{t("table.name")}</th>
                                <th className="w-[20%]">{t("table.phone")}</th>
                                <th className="w-[20%]">
                                    {t("table.contact")}
                                </th>
                                <th className="w-[20%]">{t("table.price")}</th>
