        ...
        <div className="w-screen h-screen bg-bgr ">
            ...
            >
                ...
                <div className="flex justify-end cursor-pointer">
                    <div className="w-[220px] h-[77px] flex rounded-3xl bg-white shadow-lg">
                ...
                <div className="flex">
                    <div className="inline-flex flex-1 mx-20 items-center justify-center gap-10 justify-between">
