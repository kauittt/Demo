...
const LoginPage = () => {
    ...
    const validationSchema = Yup.object({
        username: Yup.string()
            .min(4, t("error.username.min"))
            .max(15, t("error.username.max"))
        ...
        ...(purpose == "register" && {
            ...
            phone: Yup.string()
                .matches(/^[0-9]+$/, t("error.phone.matches"))
                .min(10, t("error.phone.min"))
                .max(10, t("error.phone.max"))
                .required(t("error.phone.required")),
            address: Yup.string().required(t("error.phone.required")),
        }),
    });
    ...
    const doRegister = async (credentials) => {
        try {
            ...
            if (data) {
                setPurpose("login");
                const action = t("common:register");
                toast.info(t("common:message", { type: action }), {
                    position: "top-right",
                    autoClose: 5000,
                    hideProgressBar: false,
